...
function parseQuestions() {
  const rawText = fs.readFileSync('raw_unidad4.txt', 'utf8');
...
async function run() {
  ...
  console.log("Creating quiz deck unidad4CD...");
  ...
  console.log(`Done inserting ${questionsData.length} questions for unidad4CD!`);
}
