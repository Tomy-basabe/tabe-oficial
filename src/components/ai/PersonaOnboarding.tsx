...
export function PersonaOnboarding({ onComplete, onCancel }: PersonaOnboardingProps) {
    ...
    if (step === 0) {
        return (
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
                <div className="bg-card text-foreground border-4 border-foreground rounded-xl p-6 max-w-md w-full shadow-[8px_8px_0_0_hsl(var(--foreground))] animate-in fade-in zoom-in-95 duration-300">
                    <div className="flex items-center gap-3 mb-6">
                        <div className="p-2 rounded-xl bg-[#00E5FF] border-2 border-foreground shadow-[2px_2px_0_0_hsl(var(--foreground))]">
                            <Sparkles className="w-5 h-5 !text-black" strokeWidth={2.5} />
                        </div>
                        <div>
                            <h2 className="text-xl font-black uppercase text-foreground">Crear nueva IA</h2>
                            <p className="text-xs font-bold text-muted-foreground uppercase">Dale un nombre y elegí un emoji</p>
                        </div>
                    </div>

                    <div className="space-y-4">
                        <div>
                            <label className="text-sm font-black text-foreground uppercase mb-1.5 block">
                                Nombre
                            </label>
                            <input
                                type="text"
                                ...
                                className="w-full px-4 py-3 bg-background border-4 border-foreground rounded-xl text-sm font-bold focus:outline-none focus:ring-0 shadow-[4px_4px_0_0_hsl(var(--foreground))] text-foreground"
                                autoFocus
                                maxLength={30}
                            />
                        </div>
                        ...
                        <div>
                            <label className="text-sm font-black text-foreground uppercase mb-2 block">
                                Emoji
                            </label>
                                ...
                                {EMOJI_OPTIONS.map((e) => (
                                    <button
                                        ...
                                        className={cn(
                                            ...
                                            emoji === e
                                                ? "bg-[#BFFF00] border-2 border-foreground shadow-[2px_2px_0_0_hsl(var(--foreground))] scale-110"
                                                : "bg-muted border-2 border-transparent hover:border-foreground hover:scale-110 text-foreground"
                                        )}
                                    >
                                        {e}
                                    </button>
                    ...
                    <div className="flex gap-3 mt-8">
                        <Button variant="ghost" onClick={onCancel} className="flex-1 border-4 border-foreground font-black uppercase text-foreground hover:bg-muted">
                            Cancelar
                        </Button>
                        <Button
                            onClick={() => setStep(1)}
                            disabled={!name.trim()}
                            className="flex-1 gap-2 bg-[#00E5FF] hover:bg-[#00cce6] !text-black border-4 border-foreground shadow-[4px_4px_0_0_hsl(var(--foreground))] hover:translate-y-[-2px] hover:shadow-[4px_4px_0_0_hsl(var(--foreground))] font-black uppercase"
                        >
                            Siguiente <ArrowRight className="w-4 h-4 !text-black" strokeWidth={3} />
                        </Button>
                    </div>
                </div>
            </div>
    ...
    if (questionIndex < PERSONALITY_QUESTIONS.length) {
        ...
        return (
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
                <div className="bg-card text-foreground border-4 border-foreground rounded-xl p-6 max-w-md w-full shadow-[8px_8px_0_0_hsl(var(--foreground))] animate-in fade-in slide-in-from-right-4 duration-300">
                    <div className="flex items-center gap-3 mb-4">
                        <span className="text-3xl">{emoji}</span>
                        <span className="text-xl font-black uppercase text-foreground">{name}</span>
                    </div>
                        ...
                        <div className="flex gap-1.5 mb-4">
                            {PERSONALITY_QUESTIONS.map((_, i) => (
                                <div
                                    key={i}
                                    className={cn(
                                        "h-2 flex-1 rounded-full transition-colors border-2 border-foreground",
                                        i <= questionIndex ? "bg-[#BFFF00]" : "bg-muted"
                                    )}
                                />
                            ))}
                        </div>
                        ...
                        {question.options.map((option) => (
                            ...
                            >
                                ...
                                <span className={cn(
                                    ...
                                    answers[question.id] === option.value ? "!text-black" : "text-foreground"
                                )}>{option.label}</span>
                            </button>
                        ))}
                    </div>
                    ...
                    <div className="flex gap-3 mt-8">
                        <Button
                            ...
                            className="flex-1 border-4 border-foreground font-black uppercase text-foreground hover:bg-muted"
                        >
                            Atrás
                        </Button>
                    </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
            <div className="bg-card text-foreground border-4 border-foreground rounded-xl p-6 max-w-md w-full shadow-[8px_8px_0_0_hsl(var(--foreground))] animate-in fade-in zoom-in-95 duration-300">
                <div className="text-center mb-6">
                    ...
                    <h2 className="text-2xl font-black uppercase text-foreground">{name}</h2>
                    <p className="text-sm font-bold text-muted-foreground mt-1 uppercase">
                        Tu nueva IA está lista
                    </p>
                </div>

                <div className="bg-muted border-4 border-foreground shadow-[4px_4px_0_0_hsl(var(--foreground))] rounded-xl p-4 mb-6">
                    <div className="flex items-center justify-between mb-3">
                        ...
                        <button
                            ...
                            className="flex items-center gap-1.5 text-xs font-black uppercase bg-[#00E5FF] border-2 border-foreground px-2 py-1 rounded shadow-[2px_2px_0_0_hsl(var(--foreground))] !text-black hover:translate-y-[-2px]"
                        >
                    ...
                    {isEditingPrompt ? (
                        <div className="space-y-3">
                            <textarea
                                ...
                                className="w-full px-3 py-3 bg-background border-2 border-foreground rounded-lg text-sm font-bold focus:outline-none focus:ring-0 shadow-inner resize-none leading-relaxed text-foreground"
                                rows={5}
                            ...
                            <button
                                ...
                                className="text-xs font-black uppercase text-foreground hover:underline"
                            >
                ...
                <div className="flex gap-3">
                    ...
                    <Button onClick={handleFinish} className="flex-1 gap-2 bg-[#BFFF00] hover:bg-[#a6e600] !text-black border-4 border-foreground shadow-[4px_4px_0_0_hsl(var(--foreground))] hover:translate-y-[-2px] hover:shadow-[4px_4px_0_0_hsl(var(--foreground))] font-black uppercase">
                        <Check className="w-5 h-5 !text-black" strokeWidth={3} /> Crear IA
                    </Button>
                </div>
            </div>
        </div>
