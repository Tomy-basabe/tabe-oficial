...
import { Coins, Loader2, Info, Leaf, Snowflake, Palette, User, Check, AlertCircle, ShoppingBag, Package } from "lucide-react";
                ...
                <DialogHeader>
                    <div className="flex items-center justify-between mb-2">
                        <DialogTitle className="flex items-center gap-2 text-2xl font-display">
                            ...
                            {view === 'tienda' ? 'Tienda de Puntos' : 'Mi Inventario'}
                        </DialogTitle>
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <div className="flex items-center gap-2">
                                                    {itemDetails.type === 'fertilizer' ? (
                                                        <Button
                                                            size="sm"
                                                            className="bg-neon-green hover:bg-neon-green/90 text-black font-bold h-9 transition-transform active:scale-95"
